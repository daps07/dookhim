...
from .forms import LoginForm, MyPasswordChangeForm, MyPasswordResetForm, MyPasswordResetConfirm
...
urlpatterns = [
                  ...
                  path('password-reset-confirm/<uidb64>/<token>/', auth_views.PasswordResetConfirmView.as_view(template_name='app/password_reset_confirm.html',
                       form_class=MyPasswordResetConfirm), name='password_reset_confirm'),
